...
let IngestionService = class IngestionService {
    constructor(meterRepo, vehicleRepo) {
...
exports.IngestionService = IngestionService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(meter_history_entity_1.MeterHistory)),
    __param(1, (0, typeorm_1.InjectRepository)(vehicle_history_entity_1.VehicleHistory)),
