...
const meter_live_entity_1 = require("../models/meter-live.entity");
const vehicle_live_entity_1 = require("../models/vehicle-live.entity");
    ...
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([
                meter_history_entity_1.MeterHistory,
                vehicle_history_entity_1.VehicleHistory,
                meter_live_entity_1.MeterLive,
                vehicle_live_entity_1.VehicleLive,
            ]),
        ],
